...
public class CartController {
	...
	public String insertCart(@ModelAttribute CartDTO_VO vo, HttpSession session) {
	...
	public String selectCart(HttpSession session, Model model) {
		...
		List<CartDTO_VO> list=cartService.selectCart(user_id); //장바구니 정보
